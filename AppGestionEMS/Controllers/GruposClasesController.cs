...
namespace AppGestionEMS.Controllers
{
    ...
    public class GruposClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,CapacidadAlumnosGrupo")] GruposClase gruposClase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,CapacidadAlumnosGrupo")] GruposClase gruposClase)
        {
            if (ModelState.IsValid)
            {
